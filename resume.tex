...
\item[2012--Present] {
  \stitle{Doctor of Philosophy}, Computer Science \\
...
\item[Aug 2012] {
  ...
  Thesis: ``RDIS: A Domain Model for Generalizing the Mappings Between Robotic Software Frameworks and Robotic Devices'' \\
  The University of Alabama, Tuscaloosa, AL \\
  Advisor: Monica Anderson, Ph.D. \\
}
